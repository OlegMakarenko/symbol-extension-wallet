...
import { AccountService, MosaicService, NamespaceService } from '@/services';
...
export default {
    ...
    actions: {
        ...
        loadState: async ({ commit, state }) => {
            ...
            const currentAccount = networkAccounts.find((account) => account.publicKey === selectedAccountId) || networkAccounts[0];
